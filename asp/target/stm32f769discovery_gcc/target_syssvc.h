 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2017-02-11 17:01:13Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f769-discovery用）
 *
 ...
 *  システムクロックの定義
 */
#define SystemFrequency     200000000
#define SysFreHCLK          200000000	/* HCLK = MasterClock / 1 */
#define SysFrePCLK1         50000000	/* PCLK1 = HCLK / 4 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f769-discovery(Cortex-M7)"
