 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2018-05-20 18:28:19Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f723-discovery用）
 *
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f723-discovery(Cortex-M7)"

/*
 *  起動メッセージの著作権表示
 */
#define TARGET_COPYRIGHT \
"Copyright (C) 2015-2018 by Education Working Group TOPPERS PROJECT, JAPAN\n" \
