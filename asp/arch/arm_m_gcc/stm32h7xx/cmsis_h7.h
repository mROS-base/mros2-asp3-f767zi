 ...
 * 
 *  @(#) $Id: cmsis.h,v 1.1 2019/07/23 21:34:43 roi Exp $
 */
...
#define TOFF_SCB_DCISW      0x0260		/* (W)  D-Cache Invalidate by Set-way */
  ...
  #define SCB_DCISW_SET_Msk           (0x1FF << SCB_DCISW_SET_Pos)			/* SCB DCISW: Set Mask */
  #define SCB_DCISW_WAY_Pos           30									/* SCB DCISW: Way Position */
  #define SCB_DCISW_WAY_Msk           (3 << SCB_DCISW_WAY_Pos)				/* SCB DCISW: Way Mask */
